...
#Global Values
min_index = 180 #269 = ~90 degrees to the right
max_index = 900 #809 = ~90 degrees to the left
...
class reactive_follow_gap:
    def __init__(self):
        ...
        self.drive_pub = rospy.Publisher('/vesc/low_level/ackermann_cmd_mux/input/navigation', AckermannDriveStamped, queue_size=1) #TODO
	...
	#print("right: " + str(ranges[0]))
	#print("left: " + str(ranges[len(ranges)-1]))
